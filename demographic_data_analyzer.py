...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = df.groupby('sex')['age'].mean().loc['Male'].round(decimals=1)
    ...
    rich_percentage = round(len(df[(df['salary'] == '>50K')&(df['hours-per-week'] == min_work_hours)]) / num_min_workers * 100,1)
